  ...
  return (
    ...
    <Formik
      ...
      validationSchema={Yup.object().shape({
        ...
        password: Yup.string()
          .min(6, 'Kata sandi setidaknya mengandung 6 karakter')
        ...
        return (
          <div className="app">
            ...
            <Form style={{ minWidth: '375px' }} {...formItemLayout} onSubmit={handleSubmit} >
              ...
              <Form.Item required label="Kata sandi" hasFeedback validateStatus={errors.password && touched.password ? "error" : 'success'}>
                <Input
                  id="password"
