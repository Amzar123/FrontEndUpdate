                    ...
                    <div class="row people">
                        <div class="col-md-6 col-lg-4 item">
                            <div class="box">
                                ...
                                <p class="description">"Aim for the moon. If you miss, you may hit a star"</p>
                        ...
                        <div class="col-md-6 col-lg-4 item">
                            <div class="box">
                                ...
                                <p class="description">"Saya Orang Paling Ganteng se-Dunia"</p>
                                <div class="social"><a href="#"><i class="fa fa-facebook-official"></i></a><a href="#"><i class="fa fa-twitter"></i></a><a href="#"><i class="fa fa-instagram"></i></a></div>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 item">
                        ...
                        <div class="col-md-6 col-lg-4 item">
                            <div class="box">
                                ...
                                <p class="description">"Saya Orang Paling Cantik se-Dunia"</p>
                                <div class="social"><a href="#"><i class="fa fa-facebook-official"></i></a><a href="#"><i class="fa fa-twitter"></i></a><a href="#"><i class="fa fa-instagram"></i></a></div>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4 item">
                            <div class="box">
                                ...
                                <h3 class="name">Aji Muhammad Z.</h3>
                                <p class="title">Technical Officer</p>
